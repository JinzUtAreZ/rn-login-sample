...
import * as Auth from "../../store/reducers/authReducers";
...
const Register = props => {
  ...
  //// REGISTER_ADD Register_User in ../store/auth /////
      ...
      >
        ...
        <View style={styles.screen}>
          <View style={styles.item}>
            {/* <InputTest label="FirstName" txtname="fName" required />
            <InputTest label="LastName" txtname="lName" /> 
            Tetestingin ko pa to medyo mahirap ung parent-child
            */}
            ...
            <View style={styles.inputForm}>
              ...
              <View style={styles.passwordContainer}>
                <TextInput
                  ...
                  onChangeText={text => setValue("password", text, true, 2, 10)}
            ...
            <View>
              <Button title="Testing" onPress={handleSubmit(onSubmit)} />
            </View> */}
            ...
            <View style={styles.inputForm}>
              ...
              <View style={styles.passwordContainer}>
                <TextInput
                  ...
                  onChangeText={text => setValue("lastName", text, true, 2, 10)}
                />
              </View>
              <View style={styles.errorContainer}>
